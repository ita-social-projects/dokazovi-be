...
ALTER TABLE PUBLIC.POSTS DROP COLUMN AUTHOR_ID CASCADE;

ALTER TABLE PUBLIC.CHARITIES DROP COLUMN AUTHOR_ID CASCADE;

ALTER TABLE PUBLIC.POSTS ADD COLUMN AUTHOR_ID INT;

ALTER TABLE PUBLIC.CHARITIES ADD COLUMN AUTHOR_ID INT;
...
ALTER TABLE PUBLIC.CHARITIES ADD FOREIGN KEY (AUTHOR_ID) REFERENCES PUBLIC.DOCTORS (DOCTOR_ID);

ALTER TABLE PUBLIC.POSTS ADD FOREIGN KEY (AUTHOR_ID) REFERENCES PUBLIC.DOCTORS (DOCTOR_ID);
