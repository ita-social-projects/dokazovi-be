...
VALUES (DEFAULT, 'ShtukaNovitskaya261@mail.com', '$2y$10$59GRRruj9n/T4wqElz.IEOXrhwJDoPaz8FdJQJuk4KM.iisikn0lW', 'ACTIVE', 'Щука', 'Новицкая', 'Кандидат медичних наук',
        '+380632405186',
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
INSERT INTO public.users (user_id, email, password, status, first_name, last_name, qualification, phone, bio,
                          created_at, avatar, direction_id, institution_id)
VALUES (DEFAULT, 'FadiStalin333@mail.com', '$2y$10$Qk.6cy.s7uTNKQGYFeF9/urECrBpZ4NtLEN9Hzjj0g7soVRzcGu1u', 'ACTIVE', 'Фади', 'Сталин', 'Кандидат медичних наук',
        '+380636962951',
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
INSERT INTO public.users (user_id, email, password, status, first_name, last_name, qualification, phone, bio,
                          created_at, avatar, direction_id, institution_id)
VALUES (DEFAULT, 'PamfiyTihomirov752@mail.com', '$2y$10$qoMjXIOaovHvpEHraY5pw.q.FwPaXm2PdpU83uM1GemK4dgPD6rSq', 'ACTIVE', 'Памфий', 'Тихомиров',
...
INSERT INTO public.users (user_id, email, password, status, first_name, last_name, qualification, phone, bio,
                          created_at, avatar, direction_id, institution_id)
VALUES (DEFAULT, 'FekletinyaShashkova782@mail.com', '$2y$10$6PL9y4SFgNf014aGOAsM1u9CVA.9q08tPDDe/C8.E9WXl0B0oWk3G', 'ACTIVE', 'Феклетинья', 'Шашкова',
...
INSERT INTO public.users (user_id, email, password, status, first_name, last_name, qualification, phone, bio,
                          created_at, avatar, direction_id, institution_id)
VALUES (DEFAULT, 'PalanaLitvinova514@mail.com', '$2y$10$I2VwJytpzEZi2DPzLPJk.uhcd4WIi/Ek5dMkLjQcurEZWqI0MxTl6', 'ACTIVE', 'Палана', 'Литвинова',
...
INSERT INTO public.users (user_id, email, password, status, first_name, last_name, qualification, phone, bio,
                          created_at, avatar, direction_id, institution_id)
VALUES (DEFAULT, 'GigranAlekseev32@mail.com', '$2y$10$/m6y5AVzG9yxmthcQ7M1FOsrh8EqZmFvGZjoi7lDyy04eUqQ0gnqe', 'ACTIVE', 'Гигран', 'Алексеев', 'Лікар-спеціаліст',
        '+380634724237',
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
INSERT INTO public.users (user_id, email, password, status, first_name, last_name, qualification, phone, bio,
                          created_at, avatar, direction_id, institution_id)
VALUES (DEFAULT, 'KukuriChapko624@mail.com', '$2y$10$FHxAyHKwM2AqUF582/FFhuuf.OzU6ECIpwTpMxLCeEyz0rht.hjcG', 'ACTIVE', 'Кукури', 'Чапко', 'Лікар-спеціаліст',
        '+380631793743',
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
INSERT INTO public.users (user_id, email, password, status, first_name, last_name, qualification, phone, bio,
                          created_at, avatar, direction_id, institution_id)
VALUES (DEFAULT, 'NezdaUshakov899@mail.com', '$2y$10$MqU8B7EDd7aNo/CTmr0OKeIkRQHObRBEfxMbY2LfDbvZKmsliZ3ia', 'ACTIVE', 'Незда', 'Ушаков', 'Лікар вищої категорії',
        '+380637687420',
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
INSERT INTO public.users (user_id, email, password, status, first_name, last_name, qualification, phone, bio,
                          created_at, avatar, direction_id, institution_id)
VALUES (DEFAULT, 'MiletiyChernyshov229@mail.com', '$2y$10$SvnpkOhhs4I6J7w3jLcvIe5mWakxJ3ADtquH5Tv0x70rmjPZifTSi', 'ACTIVE', 'Милетий', 'Чернышов',
...
INSERT INTO public.users (user_id, email, password, status, first_name, last_name, qualification, phone, bio,
                          created_at, avatar, direction_id, institution_id)
VALUES (DEFAULT, 'TarzhemanSokolov585@mail.com', '$2y$10$CXUu2az9AJHT23fUcXkGd.x4m.ByDOCb6e0uU8teF/Dgq2lqeHfv2', 'ACTIVE', 'Таржеман', 'Соколов',
