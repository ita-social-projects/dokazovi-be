...
VALUES (1, '1', 'init db', 'SQL', 'V1__init_db.sql', -1459533165, 'postgres', '2021-02-16 03:56:37.065122', 118, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (2, '2', 'add avatar column to users', 'SQL', 'V2__add_avatar_column_to_users.sql', -1504009636, 'postgres',
        '2021-02-16 03:56:37.202690', 2, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (3, '3', 'implemented new relations', 'SQL', 'V3__implemented_new_relations.sql', -1537435192, 'postgres',
        '2021-02-16 03:56:37.216011', 11, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (4, '4', 'user source to OtM and add city', 'SQL', 'V4__user_source_to_OtM_and_add_city.sql', 101463797,
        'postgres', '2021-02-16 03:56:37.241616', 26, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (5, '5', 'add static data', 'SQL', 'V5__add_static_data.sql', -511743438, 'postgres',
        '2021-02-16 03:56:37.284063', 16, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (6, '6', 'add demo data', 'SQL', 'V6__add_demo_data.sql', 8561230, 'postgres', '2021-02-16 03:56:37.332925', 24,
        true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (7, '7', 'add demo data 2', 'SQL', 'V7__add_demo_data_2.sql', -289188769, 'postgres',
        '2021-02-16 03:56:37.368121', 8, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (8, '8', 'add user fields for authorization', 'SQL', 'V8__add_user_fields_for_authorization.sql', 1667294378,
        'postgres', '2021-02-16 03:56:37.382184', 3, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (9, '9', 'add demo users records', 'SQL', 'V9__add_demo_users_records.sql', 1811114752, 'postgres',
        '2021-02-16 03:56:37.394884', 3, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (10, '10', 'add enable column to users', 'SQL', 'V10__add_enable_column_to_users.sql', -55150874, 'postgres',
        '2021-02-16 03:56:37.402531', 13, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (11, '11', 'add colors to directions', 'SQL', 'V11__add_colors_to_directions.sql', -1475682200, 'postgres',
        '2021-02-16 03:56:37.424521', 5, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (12, '12', 'add more demo data', 'SQL', 'V12__add_more_demo_data.sql', -1329969423, 'postgres',
        '2021-02-16 03:56:37.444571', 32, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (13, '13', 'insert new directions add unique tag contraint', 'SQL',
        'V13__insert_new_directions_add_unique_tag_contraint.sql', 870897145, 'postgres', '2021-02-16 03:56:37.481891',
        7, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (14, '14', 'remove main direction add promotion add preview', 'SQL',
        'V14__remove_main_direction_add_promotion_add_preview.sql', 478967429, 'postgres', '2021-02-16 03:56:37.495200',
        4, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (15, '15', 'remove unnecessary directions from posts', 'SQL',
        'V15__remove_unnecessary_directions_from_posts.sql', 1482807516, 'postgres', '2021-02-16 03:56:37.505159', 2,
        true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (16, '16', 'add providers table', 'SQL', 'V16__add_providers_table.sql', 2072414472, 'postgres',
        '2021-02-16 03:56:37.512406', 11, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (17, '17', 'remove mainDirection in post and add field to direction', 'SQL',
        'V17__remove_mainDirection_in_post_and_add_field_to_direction.sql', 1294020200, 'postgres',
        '2021-02-16 03:56:37.528871', 4, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (18, '18', 'added user', 'SQL', 'V18__added_user.sql', 2107611422, 'postgres', '2021-02-16 03:56:37.536600', 1,
        true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (19, '19', 'added provider', 'SQL', 'V19__added_provider.sql', 1039896095, 'postgres',
        '2021-02-16 03:56:37.543585', 3, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (20, '20', 'separate user and doctor entities', 'SQL', 'V20__separate_user_and_doctor_entities.sql', -1007312662,
        'postgres', '2021-02-16 03:56:37.550328', 27, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (21, '21', 'add published posts rating columns doctors', 'SQL',
        'V21__add_published_posts_rating_columns_doctors.sql', 1518406742, 'postgres', '2021-02-16 03:56:37.582736', 1,
        true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (22, '22', 'add demo data for doctor table separation', 'SQL',
        'V22__add_demo_data_for_doctor_table_separation.sql', -879908254, 'postgres', '2021-02-16 03:56:37.595054', 16,
        true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (23, '23', 'fill color column for directions', 'SQL', 'V23__fill_color_column_for_directions.sql', -2105993052,
        'postgres', '2021-02-16 03:56:37.615789', 2, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (24, '24', 'New roles implementation', 'SQL', 'V24__New_roles_implementation.sql', -2096170728, 'postgres',
        '2021-02-16 03:56:37.625424', 27, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (25, '25', 'Assign users to roles', 'SQL', 'V25__Assign_users_to_roles.sql', -1528316059, 'postgres',
        '2021-02-16 03:56:37.662313', 20, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by,
                                          installed_on, execution_time, success)
VALUES (26, '26', 'add demo data for qc', 'SQL', 'V26__add_demo_data_for_qc.sql', 2126082786, 'postgres',
        '2021-02-16 03:56:37.700332', 16, true);
